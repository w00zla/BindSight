...
11. **Keyboard + gamepad** (2026-09-10): every feature now covers SC's one
    ...
    `gamepad_seen`. Each device tile has an eye button (bottom right) hiding its stage tile
...
devices (2026-09-10), chips All / kb1 / gp1 / jsN, search over
...
device filter chips with counts (All / kb1 / gp1 / jsN, like the deck),
